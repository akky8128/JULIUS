...
EXP=4B UL_MAX_WHITE=7 UL_MAX_BLACK=8 UL_ELIM_UNLOCK=both bash research/alphazero/selfplay/run4x4Exp.sh

echo "########## 4C: white=8 black=8 unlock=self ##########"
EXP=4C UL_MAX_WHITE=8 UL_MAX_BLACK=8 UL_ELIM_UNLOCK=self bash research/alphazero/selfplay/run4x4Exp.sh

echo "########## 4D: white=7 black=8 unlock=self ##########"
EXP=4D UL_MAX_WHITE=7 UL_MAX_BLACK=8 UL_ELIM_UNLOCK=self bash research/alphazero/selfplay/run4x4Exp.sh

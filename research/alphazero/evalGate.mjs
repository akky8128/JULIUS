 ...
 *
 * 使い方:
 *   node research/alphazero/evalGate.mjs [--games N] [--ms 120] [--seed 1] [--maxPlies 200]
 */
...
function parseArgs(argv) {
  const a = { games: 40, ms: 120, seed: 1, maxPlies: 200, net: "research/models/genAZ001.json" };
...
async function main() {
  ...
  const gen137 = await loadNetwork("research/models/gen137.json");

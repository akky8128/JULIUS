 ...
 *
 * 使い方:
 *   node research/classic/tuneWeights.mjs [--depth 2] [--timeMs 300] [--games 100]
...
import { searchPlayer } from "../../core/ai/players.js";
...
function main() {
  ...
  if (best && best.result.ci95Low !== null && best.result.ci95Low > 0.50) {
    ...
    console.log("  → 確認マッチを推奨: node research/classic/tuneWeights.mjs --a " + best.name + " --b baseline --games 150");
  } else {

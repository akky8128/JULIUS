 ...
 * core/nnue/analysis.js の analyzeTopMoves（純関数）を、深さ d=1,2,3,...
 * と反復深化させながら繰り返し呼び出し、深さが確定するごとに部分結果を
 * メインスレッドへ progress として逐次送信する。
 *
 * NNUE ネットワークのロードは research/lab/workers/nnueWorker.js の loadNetForWorker と
 ...
 *     netPath: string,        // 例 "research/models/gen071.json"（.bin は自動導出）
 ...
 * @param {string} jsonPath - 例 "research/models/gen071.json"（.bin は自動導出）

 ...
 * ブラウザ Worker。research/lab/nnue-lab.html の CPU 対戦/観戦で genAZ* ネットを本来の強さで動かす。
 *
 ...
 *   MCTS で召喚/排除の手順を探索する。research/alphazero の学習資産をそのまま流用する
 *   （MCTS 本体は core/az/ に移設済み）。
 */
...
import { initTurnState, applyMicroAction } from "../../../core/az/microActions.mjs";
import {
  makeNode,
  expandNode,
  simulate,
...
/**
 * playTurnMcts（research/alphazero/mctsPlayer.mjs）と同一意味論だが、各マイクロ決定の探索を

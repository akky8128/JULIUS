...
Step 1 (core/nnue/features.js) と Step 2 (research/nnue/genData.mjs) が生成した
...
def parse_args():
    ...
    p.add_argument("--data", type=str, required=True, help="Path to training JSONL (e.g. research/nnue/data/gen000.jsonl)")
    p.add_argument("--out-dir", type=str, default="research/models", help="Output directory for gen{N}.bin/json/golden.json")
...
def main():
    ...
    try:
        ...
        print("ERROR: PyTorch is required to run train.py. Install via `pip install -r research/nnue/requirements.txt`.", file=sys.stderr)
        sys.exit(1)

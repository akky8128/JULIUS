 ...
 *
 * 使い方:
 *   node research/nnue/relabel.mjs --in <in.jsonl> --out <out.jsonl> \
 *     --depth 5 --timeMs 1500 [--net research/models/gen137.json] [--limit N]
...
import { maxSummonsFor, normalizeBoard } from "../../core/gameLogic.js";

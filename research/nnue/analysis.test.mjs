// analysis.test.mjs — Phase 1: analyzeTopMoves (core/nnue/analysis.js) のテスト
//
// 実行方法: node --test research/nnue/analysis.test.mjs
//
// research/models/gen071.json / research/models/gen071.bin を実際にロードして検証する
...
import { analyzeTopMoves } from "../../core/nnue/analysis.js";
import { maxSummonsFor } from "../../core/gameLogic.js";

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const projectRoot = path.resolve(__dirname, "..", "..");
const jsonPath = path.join(projectRoot, "research", "models", "gen071.json");

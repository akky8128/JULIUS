 ...
 *
 * 棋譜記法は既存 js/tutorial/coords.js（diffToNotation/formatCoord/parseCoord）を
 ...
 *
 * 使い方:
 *   node tools/alphazero/playCli.mjs --white az:models/genAZ001.json:120 \
 *        --black search:models/gen137.json:120 [--maxPlies 200] [--seed 1] [--quiet]
 */
...
import { normalizeBoard, denormalizeBoard, maxSummonsFor } from "../../js/gameLogic.js";
import { diffToNotation, formatCoord } from "../../js/tutorial/coords.js";
...
async function main() {
  ...
  if (!args.white || !args.black) {
    ...
    console.error('例: --white az:models/genAZ001.json:120 --black search:models/gen137.json:120');
    process.exitCode = 1;
    return;
  }

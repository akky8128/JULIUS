 ...
 *
 * tools/nnue/genData.mjs の構造（mulberry32 / buildDataset純関数とmainの分離 /
 ...
 *
 * 使い方:
 *   node tools/alphazero/genAZData.mjs [--games N] [--depth N] [--timeMs N]
 *     [--maxPlies N] [--seed N] [--pidOffset N] [--openingRandomPlies N]
 *     [--epsilon N] [--augment 1|8] [--net models/gen137.json] [--out <path>]
 */
...
function parseArgs(argv) {
  const args = {
    ...
    epsilon: 0.25,
    augment: 8,
    out: "tools/alphazero/data/az000.jsonl",
    net: null,
  };

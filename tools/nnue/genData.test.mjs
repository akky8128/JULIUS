/**
 * genData.test.mjs — tools/nnue/genData.mjs (buildDataset) の node:test ベーステスト
 *
 * プロセス起動やファイルIOは行わず、buildDataset を直接呼び出して検証する。
 * 実行: node --test tools/nnue/genData.test.mjs
 */
...
import { featureDim, extractFeatures, NUM_SYMMETRIES } from "../../js/ai/nnue/features.js";

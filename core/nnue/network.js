 ...
 * Step 3 の PyTorch 学習パイプライン（research/nnue/train.py）が出力する
 * research/models/gen001.json（メタ情報・テンソル形状）と research/models/gen001.bin
 ...
 * research/nnue/train_mock_test.py の reference_forward（float64 numpy 実装）
 * と一致する）:
 *
 ...
 * 常に fs を優先する）。
 *
 * @param {string} jsonPathOrUrl - 例: "research/models/gen001.json" または "/research/models/gen001.json"

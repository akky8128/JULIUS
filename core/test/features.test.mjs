/**
 * features.test.mjs — core/nnue/features.js の node:test ベーステスト
 *
 * 実行: node --test core/test/features.test.mjs
 */
...
import {
  ...
  transformCell,
  transformState,
} from "../nnue/features.js";
import { maxSummonsFor } from "../gameLogic.js";

 ...
 *
 * 実行: node --test core/test/evaluate.test.mjs
 */

import { test } from "node:test";
import assert from "node:assert/strict";

import { evaluate, WEIGHTS, WIN_SCORE } from "../ai/evaluate.js";
import { randomPlayer, greedyPlayer } from "../ai/players.js";
import { checkWinCondition, maxSummonsFor, normalizeBoard } from "../gameLogic.js";
